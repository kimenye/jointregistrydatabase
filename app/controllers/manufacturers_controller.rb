class ManufacturersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @manufacturer.save
        SuperAdminMailer.manufacturer_approval(@manufacturer).deliver
        ...
        format.html { render manufacturers_path }
  ...
  private
    ...
    def manufacturer_params
      params.require(:manufacturer).permit(:name, :website, :email, :approved, :logo)
    end
end
